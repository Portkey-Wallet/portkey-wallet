...
/**
 * __useDiscoverDappBannerQuery__
 *
 * To run a query within a React component, call `useDiscoverDappBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverDappBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverDappBannerQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverDappBannerQuery(
  baseOptions?: Apollo.QueryHookOptions<DiscoverDappBannerQuery, DiscoverDappBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverDappBannerQuery, DiscoverDappBannerQueryVariables>(
    DiscoverDappBannerDocument,
    options,
  );
}
export function useDiscoverDappBannerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<DiscoverDappBannerQuery, DiscoverDappBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiscoverDappBannerQuery, DiscoverDappBannerQueryVariables>(
    DiscoverDappBannerDocument,
    options,
  );
}
export type DiscoverDappBannerQueryHookResult = ReturnType<typeof useDiscoverDappBannerQuery>;
export type DiscoverDappBannerLazyQueryHookResult = ReturnType<typeof useDiscoverDappBannerLazyQuery>;
export type DiscoverDappBannerQueryResult = Apollo.QueryResult<
  DiscoverDappBannerQuery,
  DiscoverDappBannerQueryVariables
>;
