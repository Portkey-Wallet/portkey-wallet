...
module.exports.boilerplate = fs.readFileSync(path.join(__dirname, 'boilerplate.gql'), 'utf8');
module.exports.boilerplate_by_id = fs.readFileSync(path.join(__dirname, 'boilerplate_by_id.gql'), 'utf8');
module.exports.boilerplate_aggregated = fs.readFileSync(path.join(__dirname, 'boilerplate_aggregated.gql'), 'utf8');
...
module.exports.dApp = fs.readFileSync(path.join(__dirname, 'dApp.gql'), 'utf8');
module.exports.dApp_by_id = fs.readFileSync(path.join(__dirname, 'dApp_by_id.gql'), 'utf8');
module.exports.dApp_aggregated = fs.readFileSync(path.join(__dirname, 'dApp_aggregated.gql'), 'utf8');
...
module.exports.mediaKitPage_boilerplate = fs.readFileSync(path.join(__dirname, 'mediaKitPage_boilerplate.gql'), 'utf8');
module.exports.mediaKitPage_boilerplate_by_id = fs.readFileSync(
  path.join(__dirname, 'mediaKitPage_boilerplate_by_id.gql'),
  'utf8',
);
module.exports.mediaKitPage_boilerplate_aggregated = fs.readFileSync(
  path.join(__dirname, 'mediaKitPage_boilerplate_aggregated.gql'),
  'utf8',
);
