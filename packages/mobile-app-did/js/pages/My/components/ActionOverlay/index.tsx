        ...
        {list.map((item, index) => {
          return (
            <Touchable
              ...
              <TextL style={[styles.textStyles, item?.textStyle]}>{item.title}</TextL>
            </Touchable>
          );
        })}
      </View>
...
export function showActionPopover({
  list,
  px,
  py,
  position = 'left',
  ...
  OverlayModal.show(<ActionPopover list={list} customPosition={customPosition} formatType={formatType} />, {
    customBounds: customBounds || {
