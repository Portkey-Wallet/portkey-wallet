...
export type Entrance_EntranceMatchQueryVariables = Types.Exact<{
  ...
  filter3?: Types.InputMaybe<Types.Entrance_Filter>;
  ...
  filter4?: Types.InputMaybe<Types.Entrance_EntranceMatch_Filter>;
  ...
  filter5?: Types.InputMaybe<Types.Entrance_Filter>;
  ...
  filter6?: Types.InputMaybe<Types.Entrance_EntranceMatch_Filter>;
...
export type Entrance_EntranceMatchQuery = {
  __typename?: 'Query';
  entrance_entranceMatch: Array<{
...
export const Entrance_EntranceMatchDocument = gql`
  query entrance_entranceMatch(
    ...
    $page2: Int
    $search2: String
    $filter3: entrance_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
    $search3: String
    $filter4: entrance_entranceMatch_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
    $search4: String
    $filter5: entrance_filter
    $sort5: [String]
    $limit5: Int
    $offset5: Int
    $page5: Int
    $search5: String
    $filter6: entrance_entranceMatch_filter
    $sort6: [String]
    $limit6: Int
    $offset6: Int
    $page6: Int
    ...
    entrance_entranceMatch(
      ...
      entranceMatch_id(filter: $filter, sort: $sort, limit: $limit, offset: $offset, page: $page, search: $search) {
        date_created
        date_created_func {
          year
          month
      ...
      entrance_id(filter: $filter5, sort: $sort5, limit: $limit5, offset: $offset5, page: $page5, search: $search5) {
        date_created
        date_created_func {
          year
          month
        ...
        user_created
        user_updated
        matchList(filter: $filter4, sort: $sort4, limit: $limit4, offset: $offset4, page: $page4, search: $search4) {
          entranceMatch_id(
            filter: $filter2
            sort: $sort2
            limit: $limit2
...
/**
 * __useEntrance_EntranceMatchQuery__
 *
 * To run a query within a React component, call `useEntrance_EntranceMatchQuery` and pass it any options that fit your needs.
 * When your component renders, `useEntrance_EntranceMatchQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEntrance_EntranceMatchQuery({
 *   variables: {
 ...
 * });
 */
export function useEntrance_EntranceMatchQuery(
  baseOptions?: Apollo.QueryHookOptions<Entrance_EntranceMatchQuery, Entrance_EntranceMatchQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<Entrance_EntranceMatchQuery, Entrance_EntranceMatchQueryVariables>(
    Entrance_EntranceMatchDocument,
    options,
  );
}
export function useEntrance_EntranceMatchLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<Entrance_EntranceMatchQuery, Entrance_EntranceMatchQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<Entrance_EntranceMatchQuery, Entrance_EntranceMatchQueryVariables>(
    Entrance_EntranceMatchDocument,
    options,
  );
}
export type Entrance_EntranceMatchQueryHookResult = ReturnType<typeof useEntrance_EntranceMatchQuery>;
export type Entrance_EntranceMatchLazyQueryHookResult = ReturnType<typeof useEntrance_EntranceMatchLazyQuery>;
export type Entrance_EntranceMatchQueryResult = Apollo.QueryResult<
  Entrance_EntranceMatchQuery,
  Entrance_EntranceMatchQueryVariables
>;
