...
export type Home_DAppQueryVariables = Types.Exact<{
  ...
  filter7?: Types.InputMaybe<Types.Home_DApp_Filter>;
...
export const Home_DAppDocument = gql`
  query home_dApp(
    ...
    home_dApp(filter: $filter7, sort: $sort7, limit: $limit7, offset: $offset7, page: $page7, search: $search7) {
