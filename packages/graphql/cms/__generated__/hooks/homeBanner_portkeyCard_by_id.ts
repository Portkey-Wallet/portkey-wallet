...
export type HomeBanner_PortkeyCard_By_IdQueryVariables = Types.Exact<{
...
export type HomeBanner_PortkeyCard_By_IdQuery = {
  __typename?: 'Query';
  homeBanner_portkeyCard_by_id?: {
...
export const HomeBanner_PortkeyCard_By_IdDocument = gql`
  query homeBanner_portkeyCard_by_id(
    ...
    homeBanner_portkeyCard_by_id(id: $id) {
...
/**
 * __useHomeBanner_PortkeyCard_By_IdQuery__
 *
 * To run a query within a React component, call `useHomeBanner_PortkeyCard_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useHomeBanner_PortkeyCard_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHomeBanner_PortkeyCard_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useHomeBanner_PortkeyCard_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<HomeBanner_PortkeyCard_By_IdQuery, HomeBanner_PortkeyCard_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<HomeBanner_PortkeyCard_By_IdQuery, HomeBanner_PortkeyCard_By_IdQueryVariables>(
    HomeBanner_PortkeyCard_By_IdDocument,
    options,
  );
}
export function useHomeBanner_PortkeyCard_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    HomeBanner_PortkeyCard_By_IdQuery,
    HomeBanner_PortkeyCard_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<HomeBanner_PortkeyCard_By_IdQuery, HomeBanner_PortkeyCard_By_IdQueryVariables>(
    HomeBanner_PortkeyCard_By_IdDocument,
    options,
  );
}
export type HomeBanner_PortkeyCard_By_IdQueryHookResult = ReturnType<typeof useHomeBanner_PortkeyCard_By_IdQuery>;
export type HomeBanner_PortkeyCard_By_IdLazyQueryHookResult = ReturnType<
  typeof useHomeBanner_PortkeyCard_By_IdLazyQuery
>;
export type HomeBanner_PortkeyCard_By_IdQueryResult = Apollo.QueryResult<
  HomeBanner_PortkeyCard_By_IdQuery,
  HomeBanner_PortkeyCard_By_IdQueryVariables
>;
