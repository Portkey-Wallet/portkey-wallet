...
export type TopSecondMenu_By_IdQueryVariables = Types.Exact<{
  ...
  filter1?: Types.InputMaybe<Types.TopMenu_Filter>;
  ...
  filter3?: Types.InputMaybe<Types.TopSecondMenu_Filter>;
  ...
  filter4?: Types.InputMaybe<Types.TopMenu_Filter>;
  ...
  filter5?: Types.InputMaybe<Types.NavigationType_Filter>;
...
export type TopSecondMenu_By_IdQuery = {
  __typename?: 'Query';
  topSecondMenu_by_id?: {
...
export const TopSecondMenu_By_IdDocument = gql`
  query topSecondMenu_by_id(
    ...
    $page2: Int
    $search2: String
    $filter3: topSecondMenu_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
    $search3: String
    $filter4: topMenu_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
...
/**
 * __useTopSecondMenu_By_IdQuery__
 *
 * To run a query within a React component, call `useTopSecondMenu_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopSecondMenu_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopSecondMenu_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useTopSecondMenu_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<TopSecondMenu_By_IdQuery, TopSecondMenu_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TopSecondMenu_By_IdQuery, TopSecondMenu_By_IdQueryVariables>(
    TopSecondMenu_By_IdDocument,
    options,
  );
}
export function useTopSecondMenu_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TopSecondMenu_By_IdQuery, TopSecondMenu_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TopSecondMenu_By_IdQuery, TopSecondMenu_By_IdQueryVariables>(
    TopSecondMenu_By_IdDocument,
    options,
  );
}
export type TopSecondMenu_By_IdQueryHookResult = ReturnType<typeof useTopSecondMenu_By_IdQuery>;
export type TopSecondMenu_By_IdLazyQueryHookResult = ReturnType<typeof useTopSecondMenu_By_IdLazyQuery>;
export type TopSecondMenu_By_IdQueryResult = Apollo.QueryResult<
  TopSecondMenu_By_IdQuery,
  TopSecondMenu_By_IdQueryVariables
>;
