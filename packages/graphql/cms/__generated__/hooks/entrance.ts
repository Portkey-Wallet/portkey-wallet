...
export type EntranceQueryVariables = Types.Exact<{
  ...
  filter1?: Types.InputMaybe<Types.EntranceMatch_Filter>;
  ...
  filter2?: Types.InputMaybe<Types.EntranceModuleName_Filter>;
  ...
  filter6?: Types.InputMaybe<Types.Entrance_Filter>;
  ...
  entrance: Array<{
    ...
    matchList?: Array<{
      ...
      entrance_id?: {
        ...
        matchList?: Array<{ __typename?: 'entrance_entranceMatch'; id: string } | null> | null;
...
export const EntranceDocument = gql`
  query entrance(
    ...
    $page: Int
    $search: String
    $filter1: entranceMatch_filter
    $sort1: [String]
    $limit1: Int
    $offset1: Int
    $page1: Int
    $search1: String
    $filter2: entranceModuleName_filter
    $sort2: [String]
    $limit2: Int
    $offset2: Int
    $page2: Int
    ...
    entrance(filter: $filter6, sort: $sort6, limit: $limit6, offset: $offset6, page: $page6, search: $search6) {
      date_created
      date_created_func {
        year
        month
      ...
      matchList(filter: $filter5, sort: $sort5, limit: $limit5, offset: $offset5, page: $page5, search: $search5) {
        ...
        entrance_id(filter: $filter4, sort: $sort4, limit: $limit4, offset: $offset4, page: $page4, search: $search4) {
          ...
          defaultSwitch
          id
          moduleName(filter: $filter2, sort: $sort2, limit: $limit2, offset: $offset2, page: $page2, search: $search2) {
            date_created
            date_updated
            description
            id
...
/**
 * __useEntranceQuery__
 *
 * To run a query within a React component, call `useEntranceQuery` and pass it any options that fit your needs.
 * When your component renders, `useEntranceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEntranceQuery({
 *   variables: {
 ...
 * });
 */
export function useEntranceQuery(baseOptions?: Apollo.QueryHookOptions<EntranceQuery, EntranceQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<EntranceQuery, EntranceQueryVariables>(EntranceDocument, options);
}
export function useEntranceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EntranceQuery, EntranceQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<EntranceQuery, EntranceQueryVariables>(EntranceDocument, options);
}
export type EntranceQueryHookResult = ReturnType<typeof useEntranceQuery>;
export type EntranceLazyQueryHookResult = ReturnType<typeof useEntranceLazyQuery>;
export type EntranceQueryResult = Apollo.QueryResult<EntranceQuery, EntranceQueryVariables>;
