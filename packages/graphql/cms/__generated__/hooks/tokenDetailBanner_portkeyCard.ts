...
export type TokenDetailBanner_PortkeyCardQueryVariables = Types.Exact<{
  ...
  filter7?: Types.InputMaybe<Types.TokenDetailBanner_PortkeyCard_Filter>;
...
export const TokenDetailBanner_PortkeyCardDocument = gql`
  query tokenDetailBanner_portkeyCard(
    ...
    $page6: Int
    $search6: String
    $filter7: tokenDetailBanner_portkeyCard_filter
    $sort7: [String]
    $limit7: Int
    $offset7: Int
    $page7: Int
    ...
    tokenDetailBanner_portkeyCard(
      ...
      id
      portkeyCard_id(filter: $filter2, sort: $sort2, limit: $limit2, offset: $offset2, page: $page2, search: $search2) {
        appLink
        buttonTitle
        description
        extensionLink
