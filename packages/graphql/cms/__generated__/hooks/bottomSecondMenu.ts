...
export type BottomSecondMenuQueryVariables = Types.Exact<{
  ...
  filter6?: Types.InputMaybe<Types.BottomSecondMenu_Filter>;
...
export type BottomSecondMenuQuery = {
  __typename?: 'Query';
  bottomSecondMenu: Array<{
...
export const BottomSecondMenuDocument = gql`
...
/**
 * __useBottomSecondMenuQuery__
 *
 * To run a query within a React component, call `useBottomSecondMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useBottomSecondMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBottomSecondMenuQuery({
 *   variables: {
 ...
 * });
 */
export function useBottomSecondMenuQuery(
  baseOptions?: Apollo.QueryHookOptions<BottomSecondMenuQuery, BottomSecondMenuQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BottomSecondMenuQuery, BottomSecondMenuQueryVariables>(BottomSecondMenuDocument, options);
}
export function useBottomSecondMenuLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<BottomSecondMenuQuery, BottomSecondMenuQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BottomSecondMenuQuery, BottomSecondMenuQueryVariables>(BottomSecondMenuDocument, options);
}
export type BottomSecondMenuQueryHookResult = ReturnType<typeof useBottomSecondMenuQuery>;
export type BottomSecondMenuLazyQueryHookResult = ReturnType<typeof useBottomSecondMenuLazyQuery>;
export type BottomSecondMenuQueryResult = Apollo.QueryResult<BottomSecondMenuQuery, BottomSecondMenuQueryVariables>;
