...
export type UpgradePush_AppVersionQueryVariables = Types.Exact<{
...
export type UpgradePush_AppVersionQuery = {
  __typename?: 'Query';
  upgradePush_appVersion: Array<{
...
export const UpgradePush_AppVersionDocument = gql`
  query upgradePush_appVersion(
...
/**
 * __useUpgradePush_AppVersionQuery__
 *
 * To run a query within a React component, call `useUpgradePush_AppVersionQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_AppVersionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_AppVersionQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_AppVersionQuery(
  baseOptions?: Apollo.QueryHookOptions<UpgradePush_AppVersionQuery, UpgradePush_AppVersionQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_AppVersionQuery, UpgradePush_AppVersionQueryVariables>(
    UpgradePush_AppVersionDocument,
    options,
  );
}
export function useUpgradePush_AppVersionLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UpgradePush_AppVersionQuery, UpgradePush_AppVersionQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_AppVersionQuery, UpgradePush_AppVersionQueryVariables>(
    UpgradePush_AppVersionDocument,
    options,
  );
}
export type UpgradePush_AppVersionQueryHookResult = ReturnType<typeof useUpgradePush_AppVersionQuery>;
export type UpgradePush_AppVersionLazyQueryHookResult = ReturnType<typeof useUpgradePush_AppVersionLazyQuery>;
export type UpgradePush_AppVersionQueryResult = Apollo.QueryResult<
  UpgradePush_AppVersionQuery,
  UpgradePush_AppVersionQueryVariables
>;
