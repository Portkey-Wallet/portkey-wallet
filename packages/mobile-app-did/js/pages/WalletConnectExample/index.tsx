...
function App(): JSX.Element {
  ...
  const onReadContract = async () => {
    const contract = new ethers.Contract(ContractUtils.contractAddress, ContractUtils.goerliABI, client);
  ...
  return (
    <PageContainer noCenterDom safeAreaColor={['black']} scrollViewProps={{ disabled: false }}>
      <SafeAreaView>
        ...
        <WalletConnectModal
          projectId={'6733595637fa2afd8bb831ac36a906af'}
