...
export type DiscoverEarnData_PortkeyCardQueryVariables = Types.Exact<{
  ...
  filter5?: Types.InputMaybe<Types.DiscoverEarnData_Filter>;
  ...
  filter7?: Types.InputMaybe<Types.DiscoverEarnData_PortkeyCard_Filter>;
...
export const DiscoverEarnData_PortkeyCardDocument = gql`
  query discoverEarnData_portkeyCard(
    ...
    $page4: Int
    $search4: String
    $filter5: discoverEarnData_filter
    $sort5: [String]
    $limit5: Int
    $offset5: Int
    $page5: Int
    ...
    $page6: Int
    $search6: String
    $filter7: discoverEarnData_portkeyCard_filter
    $sort7: [String]
    $limit7: Int
    $offset7: Int
    $page7: Int
