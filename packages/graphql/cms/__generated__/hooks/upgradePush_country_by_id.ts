...
export type UpgradePush_Country_By_IdQueryVariables = Types.Exact<{
...
export type UpgradePush_Country_By_IdQuery = {
  __typename?: 'Query';
  upgradePush_country_by_id?: {
...
export const UpgradePush_Country_By_IdDocument = gql`
  query upgradePush_country_by_id(
    ...
    upgradePush_country_by_id(id: $id) {
      country_id(filter: $filter, sort: $sort, limit: $limit, offset: $offset, page: $page, search: $search) {
        date_created
        date_created_func {
          year
          month
...
/**
 * __useUpgradePush_Country_By_IdQuery__
 *
 * To run a query within a React component, call `useUpgradePush_Country_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_Country_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_Country_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_Country_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<UpgradePush_Country_By_IdQuery, UpgradePush_Country_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_Country_By_IdQuery, UpgradePush_Country_By_IdQueryVariables>(
    UpgradePush_Country_By_IdDocument,
    options,
  );
}
export function useUpgradePush_Country_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UpgradePush_Country_By_IdQuery, UpgradePush_Country_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_Country_By_IdQuery, UpgradePush_Country_By_IdQueryVariables>(
    UpgradePush_Country_By_IdDocument,
    options,
  );
}
export type UpgradePush_Country_By_IdQueryHookResult = ReturnType<typeof useUpgradePush_Country_By_IdQuery>;
export type UpgradePush_Country_By_IdLazyQueryHookResult = ReturnType<typeof useUpgradePush_Country_By_IdLazyQuery>;
export type UpgradePush_Country_By_IdQueryResult = Apollo.QueryResult<
  UpgradePush_Country_By_IdQuery,
  UpgradePush_Country_By_IdQueryVariables
>;
