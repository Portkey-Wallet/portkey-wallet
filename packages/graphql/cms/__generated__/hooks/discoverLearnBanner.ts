...
export type DiscoverLearnBannerQueryVariables = Types.Exact<{
  ...
  filter2?: Types.InputMaybe<Types.DiscoverLearnBanner_PortkeyCard_Filter>;
  ...
  filter3?: Types.InputMaybe<Types.DiscoverLearnBanner_Filter>;
...
export type DiscoverLearnBannerQuery = {
  __typename?: 'Query';
  discoverLearnBanner?: {
...
export const DiscoverLearnBannerDocument = gql`
  query discoverLearnBanner(
    ...
    $page1: Int
    $search1: String
    $filter2: discoverLearnBanner_portkeyCard_filter
    $sort2: [String]
    $limit2: Int
    $offset2: Int
    $page2: Int
    $search2: String
    $filter3: discoverLearnBanner_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
...
/**
 * __useDiscoverLearnBannerQuery__
 *
 * To run a query within a React component, call `useDiscoverLearnBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverLearnBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverLearnBannerQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverLearnBannerQuery(
  baseOptions?: Apollo.QueryHookOptions<DiscoverLearnBannerQuery, DiscoverLearnBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverLearnBannerQuery, DiscoverLearnBannerQueryVariables>(
    DiscoverLearnBannerDocument,
    options,
  );
}
export function useDiscoverLearnBannerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<DiscoverLearnBannerQuery, DiscoverLearnBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiscoverLearnBannerQuery, DiscoverLearnBannerQueryVariables>(
    DiscoverLearnBannerDocument,
    options,
  );
}
export type DiscoverLearnBannerQueryHookResult = ReturnType<typeof useDiscoverLearnBannerQuery>;
export type DiscoverLearnBannerLazyQueryHookResult = ReturnType<typeof useDiscoverLearnBannerLazyQuery>;
export type DiscoverLearnBannerQueryResult = Apollo.QueryResult<
  DiscoverLearnBannerQuery,
  DiscoverLearnBannerQueryVariables
>;
