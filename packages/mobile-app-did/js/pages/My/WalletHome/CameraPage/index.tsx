...
import { useSendCurrentChannelMessage } from 'pages/Chat/components/hooks';
    ...
    <SafeAreaBox edges={['bottom', 'right', 'left']} style={PageStyle.safeAreaBox}>
      <View style={PageStyle.wrapper}>
        ...
        <View
          ...
          {img?.uri && (
            <CommonButton title="Confirm" type="primary" loading={sending} buttonStyle={PageStyle.sendButton} />
          )}
        </View>
