...
export type HomeBanner_PortkeyCardQueryVariables = Types.Exact<{
  ...
  filter6?: Types.InputMaybe<Types.HomeBanner_PortkeyCard_Filter>;
...
export const HomeBanner_PortkeyCardDocument = gql`
  query homeBanner_portkeyCard(
    ...
    $page5: Int
    $search5: String
    $filter6: homeBanner_portkeyCard_filter
    $sort6: [String]
    $limit6: Int
    $offset6: Int
    $page6: Int
    ...
    homeBanner_portkeyCard(
      ...
      id
      homeBanner_id(filter: $filter4, sort: $sort4, limit: $limit4, offset: $offset4, page: $page4, search: $search4) {
        id
        status
