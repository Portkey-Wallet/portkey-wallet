...
export type MyReferralBanner_PortkeyCard_By_IdQueryVariables = Types.Exact<{
...
export type MyReferralBanner_PortkeyCard_By_IdQuery = {
  __typename?: 'Query';
  myReferralBanner_portkeyCard_by_id?: {
...
export const MyReferralBanner_PortkeyCard_By_IdDocument = gql`
  query myReferralBanner_portkeyCard_by_id(
    ...
    myReferralBanner_portkeyCard_by_id(id: $id) {
      id
      myReferralBanner_id(
        filter: $filter5
        sort: $sort5
...
/**
 * __useMyReferralBanner_PortkeyCard_By_IdQuery__
 *
 * To run a query within a React component, call `useMyReferralBanner_PortkeyCard_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyReferralBanner_PortkeyCard_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyReferralBanner_PortkeyCard_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useMyReferralBanner_PortkeyCard_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<
    MyReferralBanner_PortkeyCard_By_IdQuery,
    MyReferralBanner_PortkeyCard_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyReferralBanner_PortkeyCard_By_IdQuery, MyReferralBanner_PortkeyCard_By_IdQueryVariables>(
    MyReferralBanner_PortkeyCard_By_IdDocument,
    options,
  );
}
export function useMyReferralBanner_PortkeyCard_By_IdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyReferralBanner_PortkeyCard_By_IdQuery, MyReferralBanner_PortkeyCard_By_IdQueryVariables>(
    MyReferralBanner_PortkeyCard_By_IdDocument,
    options,
  );
}
export type MyReferralBanner_PortkeyCard_By_IdQueryHookResult = ReturnType<
  typeof useMyReferralBanner_PortkeyCard_By_IdQuery
>;
export type MyReferralBanner_PortkeyCard_By_IdLazyQueryHookResult = ReturnType<
  typeof useMyReferralBanner_PortkeyCard_By_IdLazyQuery
>;
export type MyReferralBanner_PortkeyCard_By_IdQueryResult = Apollo.QueryResult<
  MyReferralBanner_PortkeyCard_By_IdQuery,
  MyReferralBanner_PortkeyCard_By_IdQueryVariables
>;
