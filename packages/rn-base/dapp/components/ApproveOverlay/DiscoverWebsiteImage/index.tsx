...
import Default_Image from '@portkey-wallet/rn-components/image/pngs/default_record.png';
import FastImage from '@portkey-wallet/rn-components/components/FastImage';
