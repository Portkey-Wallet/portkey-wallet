...
export type MyReferralBanner_PortkeyCardQueryVariables = Types.Exact<{
  ...
  filter4?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
  ...
  filter5?: Types.InputMaybe<Types.MyReferralBanner_Filter>;
  ...
  filter7?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
...
export const MyReferralBanner_PortkeyCardDocument = gql`
  query myReferralBanner_portkeyCard(
    ...
    $page3: Int
    $search3: String
    $filter4: myReferralBanner_portkeyCard_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
    $search4: String
    $filter5: myReferralBanner_filter
    $sort5: [String]
    $limit5: Int
    $offset5: Int
    $page5: Int
    ...
    $page6: Int
    $search6: String
    $filter7: myReferralBanner_portkeyCard_filter
    $sort7: [String]
    $limit7: Int
    $offset7: Int
    $page7: Int
