...
export type DiscoverLearnBanner_PortkeyCardQueryVariables = Types.Exact<{
  ...
  filter4?: Types.InputMaybe<Types.DiscoverLearnBanner_PortkeyCard_Filter>;
  ...
  filter5?: Types.InputMaybe<Types.DiscoverLearnBanner_Filter>;
  ...
  filter7?: Types.InputMaybe<Types.DiscoverLearnBanner_PortkeyCard_Filter>;
...
export type DiscoverLearnBanner_PortkeyCardQuery = {
  __typename?: 'Query';
  discoverLearnBanner_portkeyCard: Array<{
...
export const DiscoverLearnBanner_PortkeyCardDocument = gql`
  query discoverLearnBanner_portkeyCard(
    ...
    $page3: Int
    $search3: String
    $filter4: discoverLearnBanner_portkeyCard_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
    $search4: String
    $filter5: discoverLearnBanner_filter
    $sort5: [String]
    $limit5: Int
    $offset5: Int
    $page5: Int
    ...
    $page6: Int
    $search6: String
    $filter7: discoverLearnBanner_portkeyCard_filter
    $sort7: [String]
    $limit7: Int
    $offset7: Int
    $page7: Int
    ...
    discoverLearnBanner_portkeyCard(
      filter: $filter7
      sort: $sort7
      limit: $limit7
      offset: $offset7
...
/**
 * __useDiscoverLearnBanner_PortkeyCardQuery__
 *
 * To run a query within a React component, call `useDiscoverLearnBanner_PortkeyCardQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverLearnBanner_PortkeyCardQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverLearnBanner_PortkeyCardQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverLearnBanner_PortkeyCardQuery(
  baseOptions?: Apollo.QueryHookOptions<
    DiscoverLearnBanner_PortkeyCardQuery,
    DiscoverLearnBanner_PortkeyCardQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverLearnBanner_PortkeyCardQuery, DiscoverLearnBanner_PortkeyCardQueryVariables>(
    DiscoverLearnBanner_PortkeyCardDocument,
    options,
  );
}
export function useDiscoverLearnBanner_PortkeyCardLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiscoverLearnBanner_PortkeyCardQuery, DiscoverLearnBanner_PortkeyCardQueryVariables>(
    DiscoverLearnBanner_PortkeyCardDocument,
    options,
  );
}
export type DiscoverLearnBanner_PortkeyCardQueryHookResult = ReturnType<typeof useDiscoverLearnBanner_PortkeyCardQuery>;
export type DiscoverLearnBanner_PortkeyCardLazyQueryHookResult = ReturnType<
  typeof useDiscoverLearnBanner_PortkeyCardLazyQuery
>;
export type DiscoverLearnBanner_PortkeyCardQueryResult = Apollo.QueryResult<
  DiscoverLearnBanner_PortkeyCardQuery,
  DiscoverLearnBanner_PortkeyCardQueryVariables
>;
