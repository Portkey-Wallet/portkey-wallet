...
export type BottomSecondMenu_By_IdQueryVariables = Types.Exact<{
  ...
  filter1?: Types.InputMaybe<Types.BottomMenu_Filter>;
...
export type BottomSecondMenu_By_IdQuery = {
  __typename?: 'Query';
  bottomSecondMenu_by_id?: {
...
export const BottomSecondMenu_By_IdDocument = gql`
  query bottomSecondMenu_by_id(
 ...
 *
 * To run a query within a React component, call `useBottomSecondMenu_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useBottomSecondMenu_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBottomSecondMenu_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useBottomSecondMenu_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<BottomSecondMenu_By_IdQuery, BottomSecondMenu_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BottomSecondMenu_By_IdQuery, BottomSecondMenu_By_IdQueryVariables>(
    BottomSecondMenu_By_IdDocument,
    options,
  );
}
export function useBottomSecondMenu_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<BottomSecondMenu_By_IdQuery, BottomSecondMenu_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BottomSecondMenu_By_IdQuery, BottomSecondMenu_By_IdQueryVariables>(
    BottomSecondMenu_By_IdDocument,
    options,
  );
}
export type BottomSecondMenu_By_IdQueryHookResult = ReturnType<typeof useBottomSecondMenu_By_IdQuery>;
export type BottomSecondMenu_By_IdLazyQueryHookResult = ReturnType<typeof useBottomSecondMenu_By_IdLazyQuery>;
export type BottomSecondMenu_By_IdQueryResult = Apollo.QueryResult<
  BottomSecondMenu_By_IdQuery,
  BottomSecondMenu_By_IdQueryVariables
>;
