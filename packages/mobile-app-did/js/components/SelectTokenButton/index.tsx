...
import CryptoAssetsListOverlay from '../../pages/Chat/components/CryptoAssetsListOverlay';
...
const showSelectTokenModal = (props: ISelectTokenContentProps) => {
  CryptoAssetsListOverlay.showCryptoAssetList({
    onFinishSelectAssets: props.onSelect,
    currentSymbol: props.token.symbol,
    currentChainId: props.token.chainId,
  });
