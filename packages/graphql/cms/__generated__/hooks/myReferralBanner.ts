...
export type MyReferralBannerQueryVariables = Types.Exact<{
  ...
  filter5?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
...
export type MyReferralBannerQuery = {
  __typename?: 'Query';
  myReferralBanner?: {
...
export const MyReferralBannerDocument = gql`
  query myReferralBanner(
    ...
    $page4: Int
    $search4: String
    $filter5: myReferralBanner_portkeyCard_filter
    $sort5: [String]
    $limit5: Int
    $offset5: Int
    $page5: Int
...
/**
 * __useMyReferralBannerQuery__
 *
 * To run a query within a React component, call `useMyReferralBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyReferralBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyReferralBannerQuery({
 *   variables: {
 ...
 * });
 */
export function useMyReferralBannerQuery(
  baseOptions?: Apollo.QueryHookOptions<MyReferralBannerQuery, MyReferralBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyReferralBannerQuery, MyReferralBannerQueryVariables>(MyReferralBannerDocument, options);
}
export function useMyReferralBannerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MyReferralBannerQuery, MyReferralBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyReferralBannerQuery, MyReferralBannerQueryVariables>(MyReferralBannerDocument, options);
}
export type MyReferralBannerQueryHookResult = ReturnType<typeof useMyReferralBannerQuery>;
export type MyReferralBannerLazyQueryHookResult = ReturnType<typeof useMyReferralBannerLazyQuery>;
export type MyReferralBannerQueryResult = Apollo.QueryResult<MyReferralBannerQuery, MyReferralBannerQueryVariables>;
