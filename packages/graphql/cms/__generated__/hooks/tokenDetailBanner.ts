...
export type TokenDetailBannerQueryVariables = Types.Exact<{
  ...
  filter6?: Types.InputMaybe<Types.TokenDetailBanner_Filter>;
...
export type TokenDetailBannerQuery = {
  __typename?: 'Query';
...
export const TokenDetailBannerDocument = gql`
  query tokenDetailBanner(
    ...
    $page5: Int
    $search5: String
    $filter6: tokenDetailBanner_filter
    $sort6: [String]
    $limit6: Int
    $offset6: Int
    $page6: Int
...
/**
 * __useTokenDetailBannerQuery__
 *
 * To run a query within a React component, call `useTokenDetailBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useTokenDetailBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTokenDetailBannerQuery({
 *   variables: {
 ...
 * });
 */
export function useTokenDetailBannerQuery(
  baseOptions?: Apollo.QueryHookOptions<TokenDetailBannerQuery, TokenDetailBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TokenDetailBannerQuery, TokenDetailBannerQueryVariables>(TokenDetailBannerDocument, options);
}
export function useTokenDetailBannerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TokenDetailBannerQuery, TokenDetailBannerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TokenDetailBannerQuery, TokenDetailBannerQueryVariables>(
    TokenDetailBannerDocument,
    options,
  );
}
export type TokenDetailBannerQueryHookResult = ReturnType<typeof useTokenDetailBannerQuery>;
export type TokenDetailBannerLazyQueryHookResult = ReturnType<typeof useTokenDetailBannerLazyQuery>;
export type TokenDetailBannerQueryResult = Apollo.QueryResult<TokenDetailBannerQuery, TokenDetailBannerQueryVariables>;
