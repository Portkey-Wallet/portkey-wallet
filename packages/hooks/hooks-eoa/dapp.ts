...
import { updateSessionInfo } from '@portkey-wallet/store/store-eoa/dapp/actions';
...
export const useDapp = () => useAppEOASelector(state => state.dapp);
