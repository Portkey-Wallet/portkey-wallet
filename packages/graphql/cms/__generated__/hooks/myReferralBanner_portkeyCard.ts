...
export type MyReferralBanner_PortkeyCardQueryVariables = Types.Exact<{
  filter?: Types.InputMaybe<Types.MyReferralBanner_Filter>;
  ...
  filter3?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
  ...
  filter4?: Types.InputMaybe<Types.MyReferralBanner_Filter>;
  ...
  filter6?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
...
export type MyReferralBanner_PortkeyCardQuery = {
  __typename?: 'Query';
  myReferralBanner_portkeyCard: Array<{
...
export const MyReferralBanner_PortkeyCardDocument = gql`
  query myReferralBanner_portkeyCard(
    $filter: myReferralBanner_filter
    $sort: [String]
    $limit: Int
    $offset: Int
    $page: Int
    ...
    $page2: Int
    $search2: String
    $filter3: myReferralBanner_portkeyCard_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
    $search3: String
    $filter4: myReferralBanner_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
    ...
    $page5: Int
    $search5: String
    $filter6: myReferralBanner_portkeyCard_filter
    $sort6: [String]
    $limit6: Int
    $offset6: Int
    $page6: Int
...
/**
 * __useMyReferralBanner_PortkeyCardQuery__
 *
 * To run a query within a React component, call `useMyReferralBanner_PortkeyCardQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyReferralBanner_PortkeyCardQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyReferralBanner_PortkeyCardQuery({
 *   variables: {
 ...
 * });
 */
export function useMyReferralBanner_PortkeyCardQuery(
  baseOptions?: Apollo.QueryHookOptions<MyReferralBanner_PortkeyCardQuery, MyReferralBanner_PortkeyCardQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyReferralBanner_PortkeyCardQuery, MyReferralBanner_PortkeyCardQueryVariables>(
    MyReferralBanner_PortkeyCardDocument,
    options,
  );
}
export function useMyReferralBanner_PortkeyCardLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyReferralBanner_PortkeyCardQuery,
    MyReferralBanner_PortkeyCardQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyReferralBanner_PortkeyCardQuery, MyReferralBanner_PortkeyCardQueryVariables>(
    MyReferralBanner_PortkeyCardDocument,
    options,
  );
}
export type MyReferralBanner_PortkeyCardQueryHookResult = ReturnType<typeof useMyReferralBanner_PortkeyCardQuery>;
export type MyReferralBanner_PortkeyCardLazyQueryHookResult = ReturnType<
  typeof useMyReferralBanner_PortkeyCardLazyQuery
>;
export type MyReferralBanner_PortkeyCardQueryResult = Apollo.QueryResult<
  MyReferralBanner_PortkeyCardQuery,
  MyReferralBanner_PortkeyCardQueryVariables
>;
