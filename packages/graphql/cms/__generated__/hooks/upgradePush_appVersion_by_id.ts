...
export type UpgradePush_AppVersion_By_IdQueryVariables = Types.Exact<{
...
export type UpgradePush_AppVersion_By_IdQuery = {
  __typename?: 'Query';
  upgradePush_appVersion_by_id?: {
...
export const UpgradePush_AppVersion_By_IdDocument = gql`
  query upgradePush_appVersion_by_id(
    ...
    upgradePush_appVersion_by_id(id: $id) {
      appVersion_id(filter: $filter, sort: $sort, limit: $limit, offset: $offset, page: $page, search: $search) {
        date_created
        date_created_func {
          year
          month
...
/**
 * __useUpgradePush_AppVersion_By_IdQuery__
 *
 * To run a query within a React component, call `useUpgradePush_AppVersion_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_AppVersion_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_AppVersion_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_AppVersion_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<UpgradePush_AppVersion_By_IdQuery, UpgradePush_AppVersion_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_AppVersion_By_IdQuery, UpgradePush_AppVersion_By_IdQueryVariables>(
    UpgradePush_AppVersion_By_IdDocument,
    options,
  );
}
export function useUpgradePush_AppVersion_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UpgradePush_AppVersion_By_IdQuery,
    UpgradePush_AppVersion_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_AppVersion_By_IdQuery, UpgradePush_AppVersion_By_IdQueryVariables>(
    UpgradePush_AppVersion_By_IdDocument,
    options,
  );
}
export type UpgradePush_AppVersion_By_IdQueryHookResult = ReturnType<typeof useUpgradePush_AppVersion_By_IdQuery>;
export type UpgradePush_AppVersion_By_IdLazyQueryHookResult = ReturnType<
  typeof useUpgradePush_AppVersion_By_IdLazyQuery
>;
export type UpgradePush_AppVersion_By_IdQueryResult = Apollo.QueryResult<
  UpgradePush_AppVersion_By_IdQuery,
  UpgradePush_AppVersion_By_IdQueryVariables
>;
