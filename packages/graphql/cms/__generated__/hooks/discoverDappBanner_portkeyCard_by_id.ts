...
export type DiscoverDappBanner_PortkeyCard_By_IdQueryVariables = Types.Exact<{
...
export type DiscoverDappBanner_PortkeyCard_By_IdQuery = {
  __typename?: 'Query';
  discoverDappBanner_portkeyCard_by_id?: {
...
export const DiscoverDappBanner_PortkeyCard_By_IdDocument = gql`
  query discoverDappBanner_portkeyCard_by_id(
    ...
    discoverDappBanner_portkeyCard_by_id(id: $id) {
      discoverDappBanner_id(
        filter: $filter4
        sort: $sort4
        limit: $limit4
...
/**
 * __useDiscoverDappBanner_PortkeyCard_By_IdQuery__
 *
 * To run a query within a React component, call `useDiscoverDappBanner_PortkeyCard_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverDappBanner_PortkeyCard_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverDappBanner_PortkeyCard_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverDappBanner_PortkeyCard_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<
    DiscoverDappBanner_PortkeyCard_By_IdQuery,
    DiscoverDappBanner_PortkeyCard_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverDappBanner_PortkeyCard_By_IdQuery, DiscoverDappBanner_PortkeyCard_By_IdQueryVariables>(
    DiscoverDappBanner_PortkeyCard_By_IdDocument,
    options,
  );
}
export function useDiscoverDappBanner_PortkeyCard_By_IdLazyQuery(
  ...
  return Apollo.useLazyQuery<
    DiscoverDappBanner_PortkeyCard_By_IdQuery,
    DiscoverDappBanner_PortkeyCard_By_IdQueryVariables
  >(DiscoverDappBanner_PortkeyCard_By_IdDocument, options);
}
export type DiscoverDappBanner_PortkeyCard_By_IdQueryHookResult = ReturnType<
  typeof useDiscoverDappBanner_PortkeyCard_By_IdQuery
>;
export type DiscoverDappBanner_PortkeyCard_By_IdLazyQueryHookResult = ReturnType<
  typeof useDiscoverDappBanner_PortkeyCard_By_IdLazyQuery
>;
export type DiscoverDappBanner_PortkeyCard_By_IdQueryResult = Apollo.QueryResult<
  DiscoverDappBanner_PortkeyCard_By_IdQuery,
  DiscoverDappBanner_PortkeyCard_By_IdQueryVariables
>;
