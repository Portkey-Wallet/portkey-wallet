...
export type UpgradePush_DeviceBrandQueryVariables = Types.Exact<{
  ...
  filter16?: Types.InputMaybe<Types.UpgradePush_DeviceBrand_Filter>;
...
export type UpgradePush_DeviceBrandQuery = {
  __typename?: 'Query';
  upgradePush_deviceBrand: Array<{
...
export const UpgradePush_DeviceBrandDocument = gql`
  query upgradePush_deviceBrand(
    ...
    $page15: Int
    $search15: String
    $filter16: upgradePush_deviceBrand_filter
    $sort16: [String]
    $limit16: Int
    $offset16: Int
    $page16: Int
    ...
    upgradePush_deviceBrand(
      ...
      deviceBrand_id(filter: $filter, sort: $sort, limit: $limit, offset: $offset, page: $page, search: $search) {
        date_created
        date_created_func {
          year
          month
...
/**
 * __useUpgradePush_DeviceBrandQuery__
 *
 * To run a query within a React component, call `useUpgradePush_DeviceBrandQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_DeviceBrandQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_DeviceBrandQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_DeviceBrandQuery(
  baseOptions?: Apollo.QueryHookOptions<UpgradePush_DeviceBrandQuery, UpgradePush_DeviceBrandQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_DeviceBrandQuery, UpgradePush_DeviceBrandQueryVariables>(
    UpgradePush_DeviceBrandDocument,
    options,
  );
}
export function useUpgradePush_DeviceBrandLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UpgradePush_DeviceBrandQuery, UpgradePush_DeviceBrandQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_DeviceBrandQuery, UpgradePush_DeviceBrandQueryVariables>(
    UpgradePush_DeviceBrandDocument,
    options,
  );
}
export type UpgradePush_DeviceBrandQueryHookResult = ReturnType<typeof useUpgradePush_DeviceBrandQuery>;
export type UpgradePush_DeviceBrandLazyQueryHookResult = ReturnType<typeof useUpgradePush_DeviceBrandLazyQuery>;
export type UpgradePush_DeviceBrandQueryResult = Apollo.QueryResult<
  UpgradePush_DeviceBrandQuery,
  UpgradePush_DeviceBrandQueryVariables
>;
