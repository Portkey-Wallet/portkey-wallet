...
export type BottomMenuQueryVariables = Types.Exact<{
  ...
  filter6?: Types.InputMaybe<Types.BottomMenu_Filter>;
...
export const BottomMenuDocument = gql`
  query bottomMenu(
    ...
    bottomMenu(filter: $filter6, sort: $sort6, limit: $limit6, offset: $offset6, page: $page6, search: $search6) {
      date_created
      date_created_func {
        year
        month
...
/**
 * __useBottomMenuQuery__
 *
 * To run a query within a React component, call `useBottomMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useBottomMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBottomMenuQuery({
 *   variables: {
 ...
 * });
 */
export function useBottomMenuQuery(baseOptions?: Apollo.QueryHookOptions<BottomMenuQuery, BottomMenuQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BottomMenuQuery, BottomMenuQueryVariables>(BottomMenuDocument, options);
}
export function useBottomMenuLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<BottomMenuQuery, BottomMenuQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BottomMenuQuery, BottomMenuQueryVariables>(BottomMenuDocument, options);
}
export type BottomMenuQueryHookResult = ReturnType<typeof useBottomMenuQuery>;
export type BottomMenuLazyQueryHookResult = ReturnType<typeof useBottomMenuLazyQuery>;
export type BottomMenuQueryResult = Apollo.QueryResult<BottomMenuQuery, BottomMenuQueryVariables>;
