...
react-native bundle --platform android --entry-file index.js --bundle-output android/src/main/assets/index.android.bundle --assets-dest android/src/main/res  --dev true --reset-cache
