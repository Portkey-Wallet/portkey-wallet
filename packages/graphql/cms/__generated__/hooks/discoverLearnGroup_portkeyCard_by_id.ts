...
export type DiscoverLearnGroup_PortkeyCard_By_IdQueryVariables = Types.Exact<{
...
export type DiscoverLearnGroup_PortkeyCard_By_IdQuery = {
  __typename?: 'Query';
  discoverLearnGroup_portkeyCard_by_id?: {
...
export const DiscoverLearnGroup_PortkeyCard_By_IdDocument = gql`
  query discoverLearnGroup_portkeyCard_by_id(
    ...
    discoverLearnGroup_portkeyCard_by_id(id: $id) {
      id
      discoverLearnGroup_id(
        filter: $filter4
        sort: $sort4
...
/**
 * __useDiscoverLearnGroup_PortkeyCard_By_IdQuery__
 *
 * To run a query within a React component, call `useDiscoverLearnGroup_PortkeyCard_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverLearnGroup_PortkeyCard_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverLearnGroup_PortkeyCard_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverLearnGroup_PortkeyCard_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<
    DiscoverLearnGroup_PortkeyCard_By_IdQuery,
    DiscoverLearnGroup_PortkeyCard_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverLearnGroup_PortkeyCard_By_IdQuery, DiscoverLearnGroup_PortkeyCard_By_IdQueryVariables>(
    DiscoverLearnGroup_PortkeyCard_By_IdDocument,
    options,
  );
}
export function useDiscoverLearnGroup_PortkeyCard_By_IdLazyQuery(
  ...
  return Apollo.useLazyQuery<
    DiscoverLearnGroup_PortkeyCard_By_IdQuery,
    DiscoverLearnGroup_PortkeyCard_By_IdQueryVariables
  >(DiscoverLearnGroup_PortkeyCard_By_IdDocument, options);
}
export type DiscoverLearnGroup_PortkeyCard_By_IdQueryHookResult = ReturnType<
  typeof useDiscoverLearnGroup_PortkeyCard_By_IdQuery
>;
export type DiscoverLearnGroup_PortkeyCard_By_IdLazyQueryHookResult = ReturnType<
  typeof useDiscoverLearnGroup_PortkeyCard_By_IdLazyQuery
>;
export type DiscoverLearnGroup_PortkeyCard_By_IdQueryResult = Apollo.QueryResult<
  DiscoverLearnGroup_PortkeyCard_By_IdQuery,
  DiscoverLearnGroup_PortkeyCard_By_IdQueryVariables
>;
