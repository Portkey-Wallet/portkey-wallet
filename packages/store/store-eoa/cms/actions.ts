...
import {
  ...
  TWhiteListDappList,
} from '@portkey-wallet/types/types-eoa/cms';

export const getSocialMediaAsync = createAsyncThunk<Required<Pick<ICMSState, 'socialMediaListNetMap'>>, NetworkType>(
...
export const getTabMenuAsync = createAsyncThunk<Required<Pick<ICMSState, 'tabMenuListNetMap'>>, NetworkType>(
  'cms/getTabMenuAsync',
  async (network: NetworkType) => {
...
export const getDiscoverGroupAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'discoverGroupListNetMap'>>,
  NetworkType
>('cms/getDiscoverGroupAsync', async (network: NetworkType) => {
...
export const getRememberMeBlackListAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'rememberMeBlackListMap'>>,
  NetworkType
...
export const getLoginControlListAsync = createAsyncThunk<Required<Pick<ICMSState, 'loginModeListMap'>>, NetworkType[]>(
...
export const getHomeBannerListAsync = createAsyncThunk<Required<Pick<ICMSState, 'homeBannerListMap'>>, NetworkType>(
...
export const getDiscoverDappBannerAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'discoverDappBannerListMap'>>,
  NetworkType
...
export const getDiscoverLearnBannerAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'discoverLearnBannerListMap'>>,
  NetworkType
...
export const getTokenDetailBannerAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'tokenDetailBannerListMap'>>,
  NetworkType
...
export const getDiscoverTabAsync = createAsyncThunk<Required<Pick<ICMSState, 'discoverTabListMap'>>, NetworkType>(
...
export const getDiscoverEarnAsync = createAsyncThunk<Required<Pick<ICMSState, 'discoverEarnListMap'>>, NetworkType>(
...
export const getDiscoverLearnAsync = createAsyncThunk<
  Required<Pick<ICMSState, 'discoverLearnGroupListMap'>>,
  NetworkType
...
export const getDappWhiteListAsync = createAsyncThunk<Required<Pick<ICMSState, 'dappWhiteListMap'>>, NetworkType>(
