...
import { useCheckManagerSyncState } from '@portkey-wallet/rn-base/hooks/wallet';
import { ContractBasic } from '@portkey-wallet/contracts/utils/ContractBasic';
import { useCheckTransferLimitWithJump, useSecuritySafeCheckAndToast } from '@portkey-wallet/rn-base/hooks/security';
...
import { useGetCAContract, useGetTokenViewContract } from '@portkey-wallet/rn-base/hooks/contract';
import { useEffectOnce } from '@portkey-wallet/hooks';
import { useGetTransferFee } from '@portkey-wallet/rn-base/hooks/transfer';

const SendHome: React.FC = () => {
  console.log('route result', useRoute<RouteProp<{ params: IToSendHomeParamsType }>>());
  const {
