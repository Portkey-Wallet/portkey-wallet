...
export type UpgradePush_CountryQueryVariables = Types.Exact<{
  ...
  filter16?: Types.InputMaybe<Types.UpgradePush_Country_Filter>;
...
export type UpgradePush_CountryQuery = {
  __typename?: 'Query';
  upgradePush_country: Array<{
...
export const UpgradePush_CountryDocument = gql`
  query upgradePush_country(
    ...
    $page15: Int
    $search15: String
    $filter16: upgradePush_country_filter
    $sort16: [String]
    $limit16: Int
    $offset16: Int
    $page16: Int
...
/**
 * __useUpgradePush_CountryQuery__
 *
 * To run a query within a React component, call `useUpgradePush_CountryQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_CountryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_CountryQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_CountryQuery(
  baseOptions?: Apollo.QueryHookOptions<UpgradePush_CountryQuery, UpgradePush_CountryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_CountryQuery, UpgradePush_CountryQueryVariables>(
    UpgradePush_CountryDocument,
    options,
  );
}
export function useUpgradePush_CountryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UpgradePush_CountryQuery, UpgradePush_CountryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_CountryQuery, UpgradePush_CountryQueryVariables>(
    UpgradePush_CountryDocument,
    options,
  );
}
export type UpgradePush_CountryQueryHookResult = ReturnType<typeof useUpgradePush_CountryQuery>;
export type UpgradePush_CountryLazyQueryHookResult = ReturnType<typeof useUpgradePush_CountryLazyQuery>;
export type UpgradePush_CountryQueryResult = Apollo.QueryResult<
  UpgradePush_CountryQuery,
  UpgradePush_CountryQueryVariables
>;
