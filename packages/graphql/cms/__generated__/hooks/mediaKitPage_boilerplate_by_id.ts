...
export type MediaKitPage_Boilerplate_By_IdQueryVariables = Types.Exact<{
  ...
  filter2?: Types.InputMaybe<Types.Boilerplate_Filter>;
          ...
          mediaKitPage_id(
            ...
            mediaKitList(
              ...
              mediaKit_id(
                ...
                index
                name
                png(filter: $filter3, sort: $sort3, limit: $limit3, offset: $offset3, page: $page3, search: $search3) {
                  charset
                  description
                  duration
                  embed
                ...
                sort
                status
                svg(filter: $filter4, sort: $sort4, limit: $limit4, offset: $offset4, page: $page4, search: $search4) {
                  charset
                  description
                  duration
                  embed
