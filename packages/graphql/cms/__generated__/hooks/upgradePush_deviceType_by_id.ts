...
export type UpgradePush_DeviceType_By_IdQueryVariables = Types.Exact<{
...
export type UpgradePush_DeviceType_By_IdQuery = {
  __typename?: 'Query';
  upgradePush_deviceType_by_id?: {
...
export const UpgradePush_DeviceType_By_IdDocument = gql`
  query upgradePush_deviceType_by_id(
    ...
    upgradePush_deviceType_by_id(id: $id) {
...
/**
 * __useUpgradePush_DeviceType_By_IdQuery__
 *
 * To run a query within a React component, call `useUpgradePush_DeviceType_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpgradePush_DeviceType_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpgradePush_DeviceType_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useUpgradePush_DeviceType_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<UpgradePush_DeviceType_By_IdQuery, UpgradePush_DeviceType_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpgradePush_DeviceType_By_IdQuery, UpgradePush_DeviceType_By_IdQueryVariables>(
    UpgradePush_DeviceType_By_IdDocument,
    options,
  );
}
export function useUpgradePush_DeviceType_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UpgradePush_DeviceType_By_IdQuery,
    UpgradePush_DeviceType_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpgradePush_DeviceType_By_IdQuery, UpgradePush_DeviceType_By_IdQueryVariables>(
    UpgradePush_DeviceType_By_IdDocument,
    options,
  );
}
export type UpgradePush_DeviceType_By_IdQueryHookResult = ReturnType<typeof useUpgradePush_DeviceType_By_IdQuery>;
export type UpgradePush_DeviceType_By_IdLazyQueryHookResult = ReturnType<
  typeof useUpgradePush_DeviceType_By_IdLazyQuery
>;
export type UpgradePush_DeviceType_By_IdQueryResult = Apollo.QueryResult<
  UpgradePush_DeviceType_By_IdQuery,
  UpgradePush_DeviceType_By_IdQueryVariables
>;
