...
export type HomeBanner_PortkeyCardQueryVariables = Types.Exact<{
  filter?: Types.InputMaybe<Types.HomeBanner_Filter>;
  ...
  filter5?: Types.InputMaybe<Types.HomeBanner_Filter>;
  ...
  filter7?: Types.InputMaybe<Types.HomeBanner_PortkeyCard_Filter>;
...
export type HomeBanner_PortkeyCardQuery = {
  __typename?: 'Query';
  homeBanner_portkeyCard: Array<{
...
export const HomeBanner_PortkeyCardDocument = gql`
  query homeBanner_portkeyCard(
    $filter: homeBanner_filter
    $sort: [String]
    $limit: Int
    $offset: Int
    $page: Int
    ...
    $page6: Int
    $search6: String
    $filter7: homeBanner_portkeyCard_filter
    $sort7: [String]
    $limit7: Int
    $offset7: Int
    $page7: Int
    ...
    homeBanner_portkeyCard(
      ...
      homeBanner_id(filter: $filter5, sort: $sort5, limit: $limit5, offset: $offset5, page: $page5, search: $search5) {
        id
        status
        items(filter: $filter4, sort: $sort4, limit: $limit4, offset: $offset4, page: $page4, search: $search4) {
          homeBanner_id(filter: $filter, sort: $sort, limit: $limit, offset: $offset, page: $page, search: $search) {
            id
            status
            items_func {
              count
...
/**
 * __useHomeBanner_PortkeyCardQuery__
 *
 * To run a query within a React component, call `useHomeBanner_PortkeyCardQuery` and pass it any options that fit your needs.
 * When your component renders, `useHomeBanner_PortkeyCardQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHomeBanner_PortkeyCardQuery({
 *   variables: {
 ...
 * });
 */
export function useHomeBanner_PortkeyCardQuery(
  baseOptions?: Apollo.QueryHookOptions<HomeBanner_PortkeyCardQuery, HomeBanner_PortkeyCardQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<HomeBanner_PortkeyCardQuery, HomeBanner_PortkeyCardQueryVariables>(
    HomeBanner_PortkeyCardDocument,
    options,
  );
}
export function useHomeBanner_PortkeyCardLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<HomeBanner_PortkeyCardQuery, HomeBanner_PortkeyCardQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<HomeBanner_PortkeyCardQuery, HomeBanner_PortkeyCardQueryVariables>(
    HomeBanner_PortkeyCardDocument,
    options,
  );
}
export type HomeBanner_PortkeyCardQueryHookResult = ReturnType<typeof useHomeBanner_PortkeyCardQuery>;
export type HomeBanner_PortkeyCardLazyQueryHookResult = ReturnType<typeof useHomeBanner_PortkeyCardLazyQuery>;
export type HomeBanner_PortkeyCardQueryResult = Apollo.QueryResult<
  HomeBanner_PortkeyCardQuery,
  HomeBanner_PortkeyCardQueryVariables
>;
