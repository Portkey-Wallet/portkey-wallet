...
export function useVerifyGoogleToken() {
  ...
  return useCallback(
    async (params: VerifyTokenParams) => {
      ...
      console.log('invoke useVerifyGoogleToken callback');
...
export function useVerifierAuth() {
  ...
  return useCallback(
    async ({
      ...
      console.log('useVerifierAuth verifyToken');
