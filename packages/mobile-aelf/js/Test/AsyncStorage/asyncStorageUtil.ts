...
import { ILocalStorage } from '../@types/common';
...
export const storeData = async (storage_Key: TStorageKey, value: TStoreData) => {
...
export const getData = async (storage_Key: TStorageKey) => {
  try {
