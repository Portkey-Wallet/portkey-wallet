...
export type DiscoverEarnData_PortkeyCardQueryVariables = Types.Exact<{
  filter?: Types.InputMaybe<Types.DiscoverEarnData_Filter>;
  ...
  filter3?: Types.InputMaybe<Types.DiscoverEarnData_PortkeyCard_Filter>;
  ...
  filter4?: Types.InputMaybe<Types.DiscoverEarnData_Filter>;
  ...
  filter6?: Types.InputMaybe<Types.DiscoverEarnData_PortkeyCard_Filter>;
...
export type DiscoverEarnData_PortkeyCardQuery = {
  __typename?: 'Query';
  discoverEarnData_portkeyCard: Array<{
...
export const DiscoverEarnData_PortkeyCardDocument = gql`
  query discoverEarnData_portkeyCard(
    $filter: discoverEarnData_filter
    $sort: [String]
    $limit: Int
    $offset: Int
    $page: Int
    ...
    $page2: Int
    $search2: String
    $filter3: discoverEarnData_portkeyCard_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
    $search3: String
    $filter4: discoverEarnData_filter
    $sort4: [String]
    $limit4: Int
    $offset4: Int
    $page4: Int
    ...
    $page5: Int
    $search5: String
    $filter6: discoverEarnData_portkeyCard_filter
    $sort6: [String]
    $limit6: Int
    $offset6: Int
    $page6: Int
...
/**
 * __useDiscoverEarnData_PortkeyCardQuery__
 *
 * To run a query within a React component, call `useDiscoverEarnData_PortkeyCardQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverEarnData_PortkeyCardQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverEarnData_PortkeyCardQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverEarnData_PortkeyCardQuery(
  baseOptions?: Apollo.QueryHookOptions<DiscoverEarnData_PortkeyCardQuery, DiscoverEarnData_PortkeyCardQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverEarnData_PortkeyCardQuery, DiscoverEarnData_PortkeyCardQueryVariables>(
    DiscoverEarnData_PortkeyCardDocument,
    options,
  );
}
export function useDiscoverEarnData_PortkeyCardLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DiscoverEarnData_PortkeyCardQuery,
    DiscoverEarnData_PortkeyCardQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiscoverEarnData_PortkeyCardQuery, DiscoverEarnData_PortkeyCardQueryVariables>(
    DiscoverEarnData_PortkeyCardDocument,
    options,
  );
}
export type DiscoverEarnData_PortkeyCardQueryHookResult = ReturnType<typeof useDiscoverEarnData_PortkeyCardQuery>;
export type DiscoverEarnData_PortkeyCardLazyQueryHookResult = ReturnType<
  typeof useDiscoverEarnData_PortkeyCardLazyQuery
>;
export type DiscoverEarnData_PortkeyCardQueryResult = Apollo.QueryResult<
  DiscoverEarnData_PortkeyCardQuery,
  DiscoverEarnData_PortkeyCardQueryVariables
>;
