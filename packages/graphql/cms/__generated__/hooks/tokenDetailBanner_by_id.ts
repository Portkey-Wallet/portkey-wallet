...
export type TokenDetailBanner_By_IdQueryVariables = Types.Exact<{
  ...
  filter2?: Types.InputMaybe<Types.TokenDetailBanner_PortkeyCard_Filter>;
...
export type TokenDetailBanner_By_IdQuery = {
  __typename?: 'Query';
  tokenDetailBanner_by_id?: {
...
export const TokenDetailBanner_By_IdDocument = gql`
  query tokenDetailBanner_by_id(
    ...
    $page1: Int
    $search1: String
    $filter2: tokenDetailBanner_portkeyCard_filter
    $sort2: [String]
    $limit2: Int
    $offset2: Int
    $page2: Int
...
/**
 * __useTokenDetailBanner_By_IdQuery__
 *
 * To run a query within a React component, call `useTokenDetailBanner_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTokenDetailBanner_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTokenDetailBanner_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useTokenDetailBanner_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<TokenDetailBanner_By_IdQuery, TokenDetailBanner_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TokenDetailBanner_By_IdQuery, TokenDetailBanner_By_IdQueryVariables>(
    TokenDetailBanner_By_IdDocument,
    options,
  );
}
export function useTokenDetailBanner_By_IdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TokenDetailBanner_By_IdQuery, TokenDetailBanner_By_IdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TokenDetailBanner_By_IdQuery, TokenDetailBanner_By_IdQueryVariables>(
    TokenDetailBanner_By_IdDocument,
    options,
  );
}
export type TokenDetailBanner_By_IdQueryHookResult = ReturnType<typeof useTokenDetailBanner_By_IdQuery>;
export type TokenDetailBanner_By_IdLazyQueryHookResult = ReturnType<typeof useTokenDetailBanner_By_IdLazyQuery>;
export type TokenDetailBanner_By_IdQueryResult = Apollo.QueryResult<
  TokenDetailBanner_By_IdQuery,
  TokenDetailBanner_By_IdQueryVariables
>;
