...
export type DiscoverEarnData_PortkeyCard_By_IdQueryVariables = Types.Exact<{
...
export type DiscoverEarnData_PortkeyCard_By_IdQuery = {
  __typename?: 'Query';
  discoverEarnData_portkeyCard_by_id?: {
...
export const DiscoverEarnData_PortkeyCard_By_IdDocument = gql`
  query discoverEarnData_portkeyCard_by_id(
...
/**
 * __useDiscoverEarnData_PortkeyCard_By_IdQuery__
 *
 * To run a query within a React component, call `useDiscoverEarnData_PortkeyCard_By_IdQuery` and pass it any options that fit your needs.
 * When your component renders, `useDiscoverEarnData_PortkeyCard_By_IdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDiscoverEarnData_PortkeyCard_By_IdQuery({
 *   variables: {
 ...
 * });
 */
export function useDiscoverEarnData_PortkeyCard_By_IdQuery(
  baseOptions: Apollo.QueryHookOptions<
    DiscoverEarnData_PortkeyCard_By_IdQuery,
    DiscoverEarnData_PortkeyCard_By_IdQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiscoverEarnData_PortkeyCard_By_IdQuery, DiscoverEarnData_PortkeyCard_By_IdQueryVariables>(
    DiscoverEarnData_PortkeyCard_By_IdDocument,
    options,
  );
}
export function useDiscoverEarnData_PortkeyCard_By_IdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiscoverEarnData_PortkeyCard_By_IdQuery, DiscoverEarnData_PortkeyCard_By_IdQueryVariables>(
    DiscoverEarnData_PortkeyCard_By_IdDocument,
    options,
  );
}
export type DiscoverEarnData_PortkeyCard_By_IdQueryHookResult = ReturnType<
  typeof useDiscoverEarnData_PortkeyCard_By_IdQuery
>;
export type DiscoverEarnData_PortkeyCard_By_IdLazyQueryHookResult = ReturnType<
  typeof useDiscoverEarnData_PortkeyCard_By_IdLazyQuery
>;
export type DiscoverEarnData_PortkeyCard_By_IdQueryResult = Apollo.QueryResult<
  DiscoverEarnData_PortkeyCard_By_IdQuery,
  DiscoverEarnData_PortkeyCard_By_IdQueryVariables
>;
