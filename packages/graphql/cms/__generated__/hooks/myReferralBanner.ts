...
export type MyReferralBannerQueryVariables = Types.Exact<{
  ...
  filter2?: Types.InputMaybe<Types.MyReferralBanner_PortkeyCard_Filter>;
  ...
  filter3?: Types.InputMaybe<Types.MyReferralBanner_Filter>;
...
export const MyReferralBannerDocument = gql`
  query myReferralBanner(
    ...
    $page1: Int
    $search1: String
    $filter2: myReferralBanner_portkeyCard_filter
    $sort2: [String]
    $limit2: Int
    $offset2: Int
    $page2: Int
    $search2: String
    $filter3: myReferralBanner_filter
    $sort3: [String]
    $limit3: Int
    $offset3: Int
    $page3: Int
