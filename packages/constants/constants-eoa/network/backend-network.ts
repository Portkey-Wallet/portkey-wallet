...
export const BackEndNetWorkMap: {
  ...
  'back-end-testnet': {
    ...
    cmsUrl: 'https://eoacms-test-aa.portkey.finance/graphql',
    // s3Url: 'https://portkey-cms-testnet.s3.ap-northeast-1.amazonaws.com',
    s3Url: 'https://portkey-eoa-cms-testnet.s3.ap-northeast-1.amazonaws.com',
  ...
  'back-end-mainnet': {
    ...
    cmsUrl: 'https://eoacms-aa.portkey.finance/graphql',
    s3Url: 'https://portkey-eoa-cms-mainnet.s3.ap-northeast-1.amazonaws.com',
