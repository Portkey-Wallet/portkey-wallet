...
export const ADD_AI_CHAT_ERROR_TIP = `This chat doesn't exist. Please check the Portkey group before you try again.`;

export const JOIN_OFFICIAL_GROUP_BUTTON_TITTLE = 'Join';
