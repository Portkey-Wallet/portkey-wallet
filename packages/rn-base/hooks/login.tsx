...
import { request as globalRequest } from '@portkey-wallet/rn-inject-sdk';
  ...
  return useCallback(
    async ({
      ...
      try {
        ...
        let fetch = globalRequest.wallet.requestRegister;
        if (isRecovery) {
          fetch = globalRequest.wallet.recoveryWallet;
