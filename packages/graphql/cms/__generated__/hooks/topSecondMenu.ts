...
export type TopSecondMenuQueryVariables = Types.Exact<{
  ...
  filter6?: Types.InputMaybe<Types.TopSecondMenu_Filter>;
...
export type TopSecondMenuQuery = {
  __typename?: 'Query';
  topSecondMenu: Array<{
...
export const TopSecondMenuDocument = gql`
  query topSecondMenu(
    ...
    topSecondMenu(filter: $filter6, sort: $sort6, limit: $limit6, offset: $offset6, page: $page6, search: $search6) {
      date_created
      date_created_func {
        year
        month
 ...
 *
 * To run a query within a React component, call `useTopSecondMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopSecondMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopSecondMenuQuery({
 *   variables: {
 ...
 * });
 */
export function useTopSecondMenuQuery(
  baseOptions?: Apollo.QueryHookOptions<TopSecondMenuQuery, TopSecondMenuQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TopSecondMenuQuery, TopSecondMenuQueryVariables>(TopSecondMenuDocument, options);
}
export function useTopSecondMenuLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TopSecondMenuQuery, TopSecondMenuQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TopSecondMenuQuery, TopSecondMenuQueryVariables>(TopSecondMenuDocument, options);
}
export type TopSecondMenuQueryHookResult = ReturnType<typeof useTopSecondMenuQuery>;
export type TopSecondMenuLazyQueryHookResult = ReturnType<typeof useTopSecondMenuLazyQuery>;
export type TopSecondMenuQueryResult = Apollo.QueryResult<TopSecondMenuQuery, TopSecondMenuQueryVariables>;
