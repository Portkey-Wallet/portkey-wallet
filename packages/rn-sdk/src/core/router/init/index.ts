...
// import { PortkeyEntries } from './config';
...
// import ProviderComponent from './ReduxProvider';
// import { wrapEntry } from '..';
...
// // todo need decoupling the page component
// const initEntries = () => {
...
//   // // assets module
//   // entryConfig.set(PortkeyEntries.ASSETS_HOME_ENTRY, () => ProviderComponent(AssetsHome as React.ComponentType<any>));
...
//   //   ProviderComponent(ManageTokenList as React.ComponentType<any>),
//   // );
//   // entryConfig.set(PortkeyEntries.TOKEN_MANAGE_ADD_ENTRY, () =>
//   //   ProviderComponent(CustomToken as React.ComponentType<any>),
//   // );
...
//   // entryConfig.set(PortkeyEntries.RAMP_HOME_ENTRY, () => ProviderComponent(RampHome as React.ComponentType<any>));
//   // entryConfig.set(PortkeyEntries.RAMP_PREVIEW_ENTRY, () => ProviderComponent(RampPreview as React.ComponentType<any>));
